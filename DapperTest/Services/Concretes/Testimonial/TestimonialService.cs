...
namespace DapperTest.Services.Concretes.Testimonial
{
    public class TestimonialService : ITestimonialService
    {
        ...
        {
            string query = "Insert Into TblTestimonial (FullName,Title,Description) values (@fullName,@title,@description)";
        ...
        {
            string query = "Update TblTestimonial Set FullName=@fullName, Title=@title, Description=@description Where TestimonialId=@testimonialId";
            var parameters = new DynamicParameters();
            parameters.Add("@fullName", dto.FullName);
            parameters.Add("@title", dto.Title);
            parameters.Add("@description", dto.Description);
